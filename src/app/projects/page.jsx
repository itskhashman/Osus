        ...
        {Object.entries(t.projects.sectors).map(([key, label]) => {
          ...
          return (
            <button
              ...
              className={[
                'rounded-full border px-4 py-[9px] font-sans text-xs font-bold tracking-[0.04em] transition',
                isActive
      ...
      {hasMore && (
        <div className="mt-10 flex justify-center">
          <button
            ...
            className="rounded-sm border-[1.5px] border-slate-900 bg-transparent px-[30px] py-[15px] font-sans text-[13px] font-bold tracking-[0.04em] text-slate-900 transition hover:bg-slate-900 hover:text-white"
          >
            {t.projects.loadMore}
          </button>
        </div>
